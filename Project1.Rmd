...
#price industry: daily --> price_industry_idx
#price household: daily --> price_households_idx
#natural gas price: gas --> Price?
...
#ORANGE --> PRICE INDEX HOUSEHOLDS VS INDUSTRY
monthly_means <- daily |>
  group_by(month, year) |>
...
ggplot(monthly_means, aes(x=Date)) +
